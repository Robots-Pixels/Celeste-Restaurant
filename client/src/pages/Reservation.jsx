            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className='flex flex-col h-full gap-6 md:gap-8 text-sm'>
                ...
                <div className='flex gap-4 justify-between reservation-form-div'>
                  ...
                  <div className='border-[1px] border-b-white p-3 w-full'> <input required type="text" id='bigFirstName' onChange={handleChange} value={formData.bigFirstName} placeholder='First Name' className='outline-none w-full'/> </div>
                  <div className='border-[1px] border-b-white p-3 w-full'> <input required type="text" id='bigLastName' onChange={handleChange} value={formData.bigLastName} placeholder='Last Name' className='outline-none w-full'/> </div>
                ...
                <div className='flex gap-4 justify-between reservation-form-div'>
                  ...
                  <div className='border-[1px] border-b-white p-3 w-full'> 
                    <input required type="date" placeholder='Date' id='bigDay' onChange={handleChange} value={formData.bigDay} className='outline-none w-full'/>  
                  </div>

                  <div className='border-[1px] border-b-white p-3 w-full'> 
                    <select required className='w-full outline-none' id='bigTime' onChange={handleChange} value={formData.bigTime}>
                  ...
                  <div className='border-[1px] border-b-white p-3 w-full'> 
                    <input type="email" placeholder='Email' id='bigEmail' onChange={handleChange} value={formData.bigEmail} className='outline-none w-full'/>  
                  </div>
                ...
                <div className='flex gap-4 justify-between z-3 items-center reservation-form-div'>
                  ...
                  <div className='border-1 border-b-white w-full h-30 p-3'>
                    <textarea className='h-full w-full outline-none' id='bigMessage' onChange={handleChange} value={formData.bigMessage} placeholder='Message'></textarea>
                  </div>
